...
public class DeptDTO {
	// private 접근 제한자로 deptno 인스턴스 변수를 선언하고 외부에서 직접 접근하여 수정하지 못하도록 은닉화 한다.
	private int deptno;
	// private 접근 제한자로 dname 인스턴스 변수를 선언하고 외부에서 직접 접근하여 수정하지 못하도록 은닉화 한다.
	private String dname;
	// private 접근 제한자로 loc 인스턴스 변수를 선언하고 외부에서 직접 접근하여 수정하지 못하도록 은닉화 한다.
	private String loc;
